...
class VKeyboard(ttk.Frame):
    def __init__(self, parent, target: ttk.Entry = None, **kwargs):
    ...
    def display(self):
        ...
        all_properties = {"padx": 1, "pady": 1, "ipadx": 10, "ipady": 15}
        ...
        if self.is_shift:
            ...
            shift = ttk.Button(
                self, text='Shift', width=button_width, command=self.shift
            )
